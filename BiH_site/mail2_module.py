...
def send_mail(to_email: str = "1016699242@qq.com", title: str='hello', content: str = '', files: list = None) -> bool:
    """
    发送邮件,
...
if __name__ == '__main__':
    # send_mail(to_email="583736361@qq.com", files=[{"path": "log_module.py"}], title="title", content="你好")
    send_mail(title="hello", content="hello world")
    pass
