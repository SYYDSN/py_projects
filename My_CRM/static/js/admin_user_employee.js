...
$(function () {
    ...
    // 改变客户team_sn
    change_employee_sn = function($obj){
        var employee_sn = $.trim($obj.attr("data-employee-val"));
        var user_sn = $.trim($obj.attr("data-customer-val"));
        $.post("/employee/user", {"user_sn": user_sn, "the_type": "edit", "employee_sn": employee_sn}, function (data) {
            if (data['message'] == 'success') {
