...
import re
import math
from toolbox.mail_module import send_mail
...
host = "47.98.113.173"
port = 9520
user = "spider_root"              # 数据库用户名
password = "Spider@190209"       # 数据库密码
db_name = "spider_db"        # 库名称
...
class BaseDoc:
    ...
    def query(cls, filter_dict: dict, join_cond: (list, dict) = None, sort_cond: (dict, list) = None,
        ...
        """
        本函数过于复杂,不建议使用,仅仅做参考.如需分页,请使用cls.aggregate或者原生的聚合查询
