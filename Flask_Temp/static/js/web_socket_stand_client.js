 ...
 */
var ready_status = setInterval(function () {
    ...
    if (!sid) {
        ...
        init_ws(sid);
        clearInterval(ready_status);
    }
}, 200);

var init_ws = function (sid) {
    const url = `ws://127.0.0.1:5001/ws?sid=${sid}&cors=cors`;
    ...
    let process_message = function (mes_type, arg_dict) {
        ...
        * */
        ...
        if (type === "all_last_position") {
            ...
            // 先获取高德地图初始化自定义标记点的函数。
            console.log("---all_last_position's data:");
