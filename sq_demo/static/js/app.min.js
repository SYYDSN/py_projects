...
function getWidth(){
  ...
  if(document.getElementsByTagName("body")[0].offsetWidth <= 749){
    ...
    $("body").click(function(){
      $(this).attr("class","skin-blue sidebar-mini");
      falg = true;
    })
  }
  else{
    ...
    $("body").click(function(){
      $(this).attr("class","skin-blue sidebar-mini sidebar-collapse");
      flag = true;
    })
  }
}
